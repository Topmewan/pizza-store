...
const Featured = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.wrapper} style={{transform: `translateX(${-100 * index}vw`}}> //двигаем в зависимости от индекса
        {images.map((image, i) =>
      ...
      <div className={styles.arrowContainer} style={{right: 0}}>
        <Image src='/img/arrowr.png' alt='to right' layout='fill' onClick={() => handleArrow('r')}/>
      </div>
    </div>
  );
};
